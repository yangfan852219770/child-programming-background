...
insert  into `role`(`id`,`name`,`comment`,`status`,`create_id`,`create_time`,`last_update_id`,`last_update_time`,`role_token`) values (1,'超级管理员','拥有所有权限',1,1,'2019-04-17 14:36:46',1,'2019-04-17 14:36:53','admin');
