...
-- ----------------------------
-- Table structure for collect_course
-- ----------------------------
...
-- Records of course
-- ----------------------------
INSERT INTO `course` VALUES ('1', 'Java正式课', '3', '191064', '11', '20', '1234567890', '123123132', '', '1', '1', '2019-04-18 16:52:18', '1', '2019-04-24 11:47:38');
...
CREATE TABLE `experience_course` (
  ...
  `last_update_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='体验课';

-- ----------------------------
-- Records of experience_course
-- ----------------------------
INSERT INTO `experience_course` VALUES ('2', 'java体验课', '20', '21231231232', '', null, '2019-04-23 08:00:00', '1234567890', null, '1', '1', '2019-04-22 11:16:50', null, null);
...
-- Records of grade
-- ----------------------------
INSERT INTO `grade` VALUES ('1', '7', '1', 'java-A班', '1', '5', '23123123', null, null, '2019-04-29 00:00:00', '2019-05-05 00:00:00', '[{\"day\":[\"二\",\"三\"],\"startHour\":\"12:46:59\",\"endHour\":\"13:46:59\"},{\"day\":[\"四\"],\"startHour\":\"19:26:58\",\"endHour\":\"20:26:58\"}]', '1', '1', '2019-04-18 16:36:17', '1', '2019-04-24 11:47:38');
INSERT INTO `grade` VALUES ('2', '7', '1', 'java-B班', '2', '6', '2312312', null, null, '2019-04-22 00:00:00', '2019-04-28 00:00:00', '[{\"day\":[\"五\",\"三\"],\"startHour\":\"16:47:41\",\"endHour\":\"17:47:41\"},{\"day\":[\"一\"],\"startHour\":\"19:26:58\",\"endHour\":\"20:26:58\"}]', '1', '1', '2019-04-18 16:36:53', '1', '2019-04-24 11:47:38');
...
INSERT INTO `menu` VALUES ('10', '/educationalAdministration', '教务管理', 'table', 'menu.educationalAdministration', '0', '0', 'admin,education', '1', null, null, null, '1');
INSERT INTO `menu` VALUES ('11', '/educationalAdministration/schoolManagement', '校区管理', null, 'menu.educationalAdministration.schoolManagement', '1', '10', 'admin,education', '1', null, null, null, '1');
INSERT INTO `menu` VALUES ('12', '/educationalAdministration/classroomManagement', '教室管理', null, 'menu.educationalAdministration.classroomManagement', '1', '10', 'admin,education', '1', null, null, null, '1');
INSERT INTO `menu` VALUES ('13', '/educationalAdministration/studentsManagement', '学生信息管理', null, 'menu.educationalAdministration.studentsManagement', '1', '10', 'admin,education', '1', null, null, null, '1');
INSERT INTO `menu` VALUES ('14', '/educationalAdministration/teacherManagement', '教师信息管理', null, 'menu.educationalAdministration.teacherManagement', '1', '10', 'admin,education', '1', null, null, null, '1');
INSERT INTO `menu` VALUES ('15', '/educationalAdministration/courseManagement', '课程管理', null, 'menu.educationalAdministration.courseManagement', '0', '10', 'admin,education', '1', null, null, null, '1');
INSERT INTO `menu` VALUES ('16', '/educationalAdministration/courseManagement/formal', '正式课管理', null, 'menu.educationalAdministration.courseManagement.formalCourseManagement', '1', '15', 'admin,education', '1', null, null, null, '1');
INSERT INTO `menu` VALUES ('17', '/educationalAdministration/gradeManagement', '班级管理', null, 'menu.educationalAdministration.gradeManagement', '1', '10', 'admin,education', '1', null, null, null, '1');
INSERT INTO `menu` VALUES ('18', '/educationalAdministration/courseScheduleManagement', '课程表管理', null, 'menu.educationalAdministration.courseScheduleManagement', '1', '10', 'admin,education', '1', null, null, null, '1');
...
INSERT INTO `menu` VALUES ('24', '/educationalAdministration/courseManagement/experience', '体验课管理', null, 'menu.educationalAdministration.courseManagement.experienceCourseManagement', '1', '15', 'admin,education', '1', null, null, null, '1');
INSERT INTO `menu` VALUES ('25', '/educationalAdministration/signUpManagement', '报名管理', null, 'menu.educationalAdministration.signUpManagement', '0', '10', 'admin,education', '1', null, null, null, '1');
INSERT INTO `menu` VALUES ('26', '/educationalAdministration/signUpManagement/experience', '体验课报名管理', null, 'menu.educationalAdministration.signUpManagement.signUpExperienceManagement', '1', '25', 'admin,education', '1', null, null, null, '1');
INSERT INTO `menu` VALUES ('27', '/educationalAdministration/signUpManagement/formal', '正式课报名管理', null, 'menu.educationalAdministration.signUpManagement.signUpFormalManagement', '1', '25', 'admin,education', '1', null, null, null, '1');
INSERT INTO `menu` VALUES ('28', '/educationalAdministration/courseScheduleManagement/student', '学生课程表', null, 'menu.educationalAdministration.courseScheduleManagement.studentSchedule', '1', '18', 'admin', '1', null, null, null, '1');
INSERT INTO `menu` VALUES ('29', '/educationalAdministration/courseScheduleManagement/teacher', '老师课程表', null, 'menu.educationalAdministration.courseScheduleManagement.teacherSchedule', '1', '18', 'admin', '1', null, null, null, '1');
...
-- Records of role
-- ----------------------------
INSERT INTO `role` VALUES ('1', '超级管理员', '拥有所有权限', '1', '1', '2019-04-17 14:36:46', '1', '2019-04-22 08:47:31', 'admin', '2,4,6,7,8,11,12,13,14,16,17,18,20,21,23,24,26,27');
INSERT INTO `role` VALUES ('2', '教务管理员', '负责教务管理', '1', '1', '2019-04-18 09:57:10', '1', '2019-04-24 09:20:03', 'education', '11,12,13,14,16,17,18,24,26,27');
...
CREATE TABLE `sign_up_experience_course` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='报名体验课';

-- ----------------------------
-- Records of sign_up_experience_course
-- ----------------------------
INSERT INTO `sign_up_experience_course` VALUES ('1', '2', '2', '2019-04-22 11:23:55', '1', null, null, '1', '2019-04-23 17:28:10', '0');
...
CREATE TABLE `student_course_schedule` (
  ...
  `temp_grade_id` int(11) DEFAULT NULL COMMENT '临时调课班级id',
...
CREATE TABLE `student_sign_up` (
  ...
  `last_update_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='学生正式课报名情况';

-- ----------------------------
-- Records of student_sign_up
-- ----------------------------
INSERT INTO `student_sign_up` VALUES ('1', '3', '1', '2019-04-24 08:23:09', '0', '0', '1', null, null, '1', '2019-04-24 09:04:17');
...
INSERT INTO `teacher` VALUES ('2', 'education', 'e10adc3949ba59abbe56e057f20f883e', '张喆翰', '15833655291', 'teacher/2019-04-04/24f59257-1413-4fd4-a6b1-47c5881b81cd.jpg', '未来战士工程师', null, '1', '1', '2019-04-04 17:55:27', '1', '2019-04-24 09:21:30', '2');
...
INSERT INTO `teacher` VALUES ('7', 'admin4', 'e10adc3949ba59abbe56e057f20f883e', '左学彬2', '15833655291', 'teacher/2019-04-17/6a80c32f-a74c-45a6-9318-f2f3b6170a76.png', '收到收到收到但是', null, '1', '1', '2019-04-17 16:32:55', '2', '2019-04-24 10:48:26', '1');
